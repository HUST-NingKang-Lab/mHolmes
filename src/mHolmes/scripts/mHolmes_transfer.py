...
RESULT_DIR = _export_root / "transfer_model"
RESULT_DIR.mkdir(parents=True, exist_ok=True)

_source_csv = os.environ.get("MHOLMES_SOURCE_CSV", str(DATA_DIR / "source_hip.csv"))
_target_csv = os.environ.get("MHOLMES_TARGET_CSV", str(DATA_DIR / "target_face.csv"))
...
source_df = pd.read_csv(_source_csv)
target_df = pd.read_csv(_target_csv)
ft_rate = 0.6
