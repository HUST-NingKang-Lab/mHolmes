...
RESULT_DIR = _export_root / "mask_exval"
MODEL_DIR = _export_root / "model" / "mask_exval"
LOG_DIR = _export_root / "transformers_logs" / "mask_exval"

RESULT_DIR.mkdir(parents=True, exist_ok=True)
MODEL_DIR.mkdir(parents=True, exist_ok=True)
LOG_DIR.mkdir(parents=True, exist_ok=True)

_source_csv = os.environ.get("MHOLMES_SOURCE_CSV", str(DATA_DIR / "source_hip_keytaxa.csv"))
_target_csv = os.environ.get("MHOLMES_TARGET_CSV", str(DATA_DIR / "target_face_keytaxa.csv"))
_external_csv = os.environ.get("MHOLMES_EXTERNAL_CSV", str(DATA_DIR / "val_head.csv"))
...
# CHANGED: input csv paths (CLI override)
source_full_df = pd.read_csv(_source_csv)
target_full_df = pd.read_csv(_target_csv)
val_head_df = pd.read_csv(_external_csv)
